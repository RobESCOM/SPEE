...
<s:set var="listPagosAutorizados"
	value="{{'impresión', '15', '$15 MXN', 'Pago impresiones'}}" />
		...
		<div class="row">
			<div class="col-md-12">
				<table id="tblPagosAutorizados" class="table table-striped">
					<thead>
						<tr>
							<th><s:text name="CU94_THEAD1" /></th>
							<th><s:text name="CU94_THEAD2" /></th>
							<th><s:text name="CU94_THEAD3" /></th>
							<th><s:text name="CU94_THEAD4" /></th>
							<th><s:text name="CU94_THEAD5" /></th>
						</tr>
					</thead>
					<tbody>
