					...
					<tbody>
						<s:iterator value="listCatalogoServicios" var="oservicio">
							<tr>
								...
								<td><s:text name="$"></s:text>${oservicio.monto}<s:text name=" MXN"></s:text></td>
								<td><s:if
										test="%{#oservicio.id eq @mx.ipn.escom.spee.pagos.mapeo.CatalogoArea$AreaEnum@CELEX.getIdEstatus()}">
										CELEX
									</s:if> <s:elseif
										test="%{#oservicio.id eq @mx.ipn.escom.spee.pagos.mapeo.CatalogoArea$AreaEnum@DENTALES.getIdEstatus()}">
										Servicios Dentales
									</s:elseif> <s:elseif
										test="%{#oservicio.id eq @mx.ipn.escom.spee.pagos.mapeo.CatalogoArea$AreaEnum@FOTOCOPIADO.getIdEstatus()}">
