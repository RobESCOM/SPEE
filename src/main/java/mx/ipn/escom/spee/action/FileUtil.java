...
public class FileUtil {
	...
	private static void init() {
		...
		rutaDestinoPhotoAddress = props
				.getProperty("ruta.destino.photoAddress");
	}
	...
	public static String guardarArchivo(File file, String path, String fileName)
		...
		while (fileDestino.exists()) {
			nameFile = nombreArchivo + "_" + i + "." + extension;
	 ...
	 */
	public static String guardar(String path, String fileName) {
		init();
		File temp, nuevo;
		try {
	 ...
	 * @return {@link String} cadena con el nombre del archivo que se guarda
	 */
	public static String guardarTemp(File archivo, String ruta, String nameFile) {
		init();
		String prefix = "temp_";
	...
	/**
	 * Mueve el archivo especficador en fileName al directorio path.
	 * 
	 * @param fileName
	 *            , ruta absuluta del archivo temporal
	 * @param path
	 *            , directorio al que se moverá el archivo temporal
	 * @return
	 */
	public static void moveTemp(String source, String pathTo, String fileName) {
		try {
			File filePathTo = new File(pathTo);
			if (!filePathTo.exists()) {
				System.out.println("MNE");
				filePathTo.mkdirs();
			}
			Path from = Paths.get(source);
			Path to = Paths.get(pathTo + fileName);
		...
		// pathTo.mkdir();
		// }
		// success = temp.renameTo(new File(path));
		// System.out.println("CF: " + success);
		// return success;
	}
	...
	/**
	 * @param rutaDestinoAgremet
	 *            the rutaDestinoAgremet to set
	 */
	...
	/**
	 * @param rutaDestinoPhotoAddress
	 *            the rutaDestinoPhotoAddress to set
	 */
	...
	/**
	 * @param rutaDestinoPhotoGroup
	 *            the rutaDestinoPhotoGroup to set
	 */
	...
	/**
	 * @param rutaTemporalWebapp
	 *            the rutaTemporalWebapp to set
	 */
