...
<s:set var="listPagosAutorizados"
	value="{{'Multa', '$180 MXN', 'No se regreso libro'},
	 {'Reposición credencial', '$80 MXN', 'Pago reposición credencia'}}" />
		...
		<div class="row">
			<div class="col-md-12">
				<table id="tblPagosAutorizados" class="table table-striped">
					<thead>
						<tr>
							<th><s:text name="CU93_THEAD1" /></th>
							<th><s:text name="CU93_THEAD2" /></th>
							<th><s:text name="CU93_THEAD3" /></th>
							<th><s:text name="CU93_THEAD4" /></th>
						</tr>
					</thead>
					<tbody>
